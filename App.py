...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='sairohith3@',db='cv')
...
def run():
    ...
    img = Image.open("C:/Users/lenovo/Downloads/AI-Resume-Analyzer-main/App/Logo/RESUM.png")
    st.image(img)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Team 49</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="wa.me/+917386103199" style="text-decoration: none; color: grey;">Team 49</a> through 
            <a href="https://www.linkedin.com/in/sai-rohith-kuchi-0544a5216/" style="text-decoration: none; color: grey;">Dr Bright --(Data Scientist)</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Rohith ! Total %d " % values + " User's Have Used Our Tool : )")                
